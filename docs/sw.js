...
const CACHE='mir27-shell-1.4.1';
const ASSETS=['/','/index.html','/core-v1.js?v=1.4.1','/store-v1.js?v=1.4.1','/app-v1.js?v=1.4.1','/print-v1.js?v=1.4.1','/launcher.js?v=1.4.1','/offline-v1.js?v=1.4.1','/styles-v1.css?v=1.4.1','/icon.svg','/manifest.webmanifest'];
