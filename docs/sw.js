...
const CACHE='mir27-shell-1.2.0';
const ASSETS=['/','/index.html','/core-v1.js?v=1.2.0','/store-v1.js?v=1.2.0','/app-v1.js?v=1.2.0','/print-v1.js?v=1.2.0','/launcher.js?v=1.2.0','/offline-v1.js?v=1.2.0','/styles-v1.css?v=1.2.0','/icon.svg','/manifest.webmanifest'];
