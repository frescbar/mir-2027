...
window.MIRStore={init,signIn,signOut,requestPasswordReset,updatePassword,prepareOffline,offlineInfo,removeOffline,reconnect,listBackups,backupState,loadBank,loadState,saveState,media,importBank,get offline(){return offlineMode;},get pending(){return pending;},get lastSync(){return lastSync;},get recovering(){return recovering;},get local(){return localMode;},get user(){return auth?.user||null;},get role(){return role;},API};
})();
